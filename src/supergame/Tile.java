...
public class Tile {
	...
	public static int ARC_WIDTH = 15;
	public static int ARC_HEIGHT = 15;
	...
	/**
	 * Создание изобржения плитки
	 */
	private void drawImage() {
		Graphics2D g = (Graphics2D) tileImage.getGraphics();
		if (value == 2) {
			background = new Color(0xee200a);
			text = new Color(0xffffff);
		} else if (value == 4) {
			background = new Color(0xee7b0a);
			text = new Color(0xffffff);
		} else if (value == 8) {
			background = new Color(0xeecb0a);
			text = new Color(0xffffff);
		} else if (value == 16) {
			background = new Color(0x0aee10);
			text = new Color(0xffffff);
		} else if (value == 32) {
			background = new Color(0x0aeedb);
			text = new Color(0xffffff);
		} else if (value == 64) {
			background = new Color(0x1a0aee);
			text = new Color(0xffffff);
		} else if (value == 128) {
			background = new Color(0x900aee);
			text = new Color(0xffffff);
		} else if (value == 256) {
			background = new Color(0xee0abb);
			text = new Color(0xffffff);
		} else if (value == 512) {
			background = new Color(0xee0abb);
			text = new Color(0xffffff);
		} else if (value == 1024) {
			background = new Color(0xee0a0a);
			text = new Color(0xffffff);
		} else if (value == 2048) {
			background = new Color(0xe59c00);
			text = new Color(0xffffff);
		} else {
		...
		int drawH = HEIGHT / 2 + DrawUtils.getMessageHeight("" + value, font, g) / 2;
		g.drawString("" + value, drawX, drawH);
		g.dispose();
	}
